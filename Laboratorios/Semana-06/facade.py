...
class Notificacion: 
    def enviar_notificacion(self, producto, monto):
        print(f'Se completó la siguiente compra: {producto} - {monto}')
...
class TiendaFacade:
    ...
    def comprar(self, producto, precio):
        ...
        self.notificacion.enviar_notificacion(producto, precio)
